...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el nombre del pais al que pertenece el atleta.
	 * 
	 * @param nombreAtleta El nombre del atleta buscado.
	 * @return El nombre del pais al que pertenece el atleta buscado.
	 */
	public String buscarPaisDeAtletaPorNombre(String nombreAtleta)
	{
		Atleta buscado = this.buscarAtleta(nombreAtleta);
		String pais = buscado.darPais().darNombre();
		return pais;
	}
