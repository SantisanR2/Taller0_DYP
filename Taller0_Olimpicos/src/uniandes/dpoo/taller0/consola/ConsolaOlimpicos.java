...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este método le pide al usuario el nombre de un atleta para luego retornar
	 * el nombre del pais de dicho atleta por consola.
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Consultar el país de un atleta" + "\n");
		String nombre = input("Ingrese el nombre del atleta de interés");
		String nombrePais = calculadora.buscarPaisDeAtletaPorNombre(nombre);
		System.out.println("\nEl atleta de nombre " + nombre + " pertenece al país de " + nombrePais.substring(0, 1).toUpperCase() + nombrePais.substring(1) + ".\n");
	}
